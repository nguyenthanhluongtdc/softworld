    ...
    <div class="sidenav">
        ...
        <div class="mainnav">
            <ul>
                ...
                <li>
                    <a href="#" class="hasUl"><span class="dark icon16 icomoon-icon-user-4"></span>Quản lý event</a>
                    <ul class="sub opensub">
                        <li><a href="<?=$headerUrlEvent?>"><span class="icon16 icomoon-icon-search-2 blue"></span>Danh sách</a></li>
                        <li><a href="<?=$headerUrlEventRegist?>"><span class="icon16 icomoon-icon-file-add red"></span>Tạo mới</a></li>
                ...
                <?php endif;?>
                <li><a href="<?=$urlLogout?>" onclick="return window.confirm('ログアウトしますか？')"><span class="icon16 icomoon-icon-exit-2 red"></span>Đăng xuất</a></li>
            </ul>
        </div>
    </div><!-- End sidenav -->
</div><!-- End #sidebar -->