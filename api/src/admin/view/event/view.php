                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table table-striped table-bordered table-condensed" id="EventTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="40px" style="white-space:nowrap;">Người >= 18</th>
                                        <th width="30px" style="white-space:nowrap;">Người < 18</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($listEvent as $key => $value) { ?>
                                        <tr id="<?=$d?>">
                                            ...
                                            <td><?=$value['number_adults']?></td>
                                            <td><?=$value['number_kid']?></td>
                                            <td style="text-align:center;">
                                                <a href="<?=UrlUtil::url($urlEdit, array("id"=>$value["id"]))?>" class="btn-success btn"/>Sửa</a>
                                                <input  type="button" 
                                                        submit-action = "<?=$urlDelete?>"
                                                        submit-method = "get"
                                                        submit-data='{"redirect":"<?=UrlUtil::getCurrentUrl()?>","id":<?=$value["id"]?>}' 
                                                        value="Xoá" 
