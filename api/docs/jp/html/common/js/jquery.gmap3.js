...
var markerBounds = new google.maps.LatLngBounds(); /* MAKI 2013/5/17 */
  ...
  var name_space = 'gmap3';
    ...
    function addMap($self, mpOpt) {
        ...
        var add = function() {
            ...
            /* MAKI 2013/5/17 */
            if(mpOpt.markers.length > 1){
                gmap.fitBounds(markerBounds);
            }else{
                var latlng = new google.maps.LatLng(mpOpt.markers[0].latitude,mpOpt.markers[0].longitude);
    ...
    function addMarker($gmap, mkOpt) {
        ...
        markerBounds.extend(opt.position); /* MAKI 2013/5/17 */
        var add = function() {
