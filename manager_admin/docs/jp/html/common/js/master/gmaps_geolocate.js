...
//    });
    ...
    if(geolocation){
        ...
        var successCallback = function(position){
            ...
            url += '&saddr='+lat_me+','+lon_me+'&daddr='+shop_lat+','+shop_lon+'&ttype=now';
...
//                });
        ...
        var GeolocationOption = {
            ...
            maximumAge:600000 //位置情報の有効期限（単位：ミリ秒）
        };
