...
class MessageConstants {
    ...
    const COM_CONFIRM_DELETE                = 'Bạn có chắc chắn muốn xoá không';
	...
	const COM_ERR_HAPPENED                  = 'Dữ liệu nhập không đúng, vui lòng kiểm tra lại';
    ...
    const COM_CONFIRM_SHOW                  = 'Bạn có chắc chắn muốn hiển thị lại';
}
