<div class="clearfix" id="content">
    <div class="contentwrapper">
        <!--Content wrapper-->
        <div class="heading">
            <h3>Màn hình quản lý trên cùng, Thay đổi lịch sử trường hợp, Chế độ xem chưa được xác nhận</h3>
            <div class="resBtnSearch">
                <a href="#"><span class="icon16 icomoon-icon-search-3"></span></a>
            </div>
        </div>
        <!-- End .heading-->
        Có một thông báo thay đổi vấn đề phải được chấp thuận. Vui lòng kiểm tra các thay đổi bên dưới và chấp thuận chúng.
