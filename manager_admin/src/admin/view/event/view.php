                        ...
                        <div id="DataArea" class="content noPad clearfix">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table table-striped table-bordered table-condensed" id="EventTable">
                                ...
                                <tbody>
                                    <?php $d = 1; ?>
                                    <?php 
                                    if(!StringUtil::isNullOrEmpty($listEvent)){
                                    foreach ($listEvent as $key => $value) { ?>
                                        ...
                                        <tr id="<?=$d?>">
                                            ...
                                            <td><?=date_format(date_create($value['start_time']), 'd/m/Y h:i A')?></td>
                                            <td><?=date_format(date_create($value['end_time']), 'd/m/Y h:i A')?></td>
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                <a href="<?=UrlUtil::url($urlEdit, array("id"=>$value["id"]))?>" class="btn-success btn <?=date_format(date_create($value['end_time']), 'Y-m-d\TH:i') < date("Y-m-d\TH:i") 
                                                ? "disabled" 
                                                : "" ?> " 
                                                 />Update</a>
                                                ...
                                                <input  type="hidden" 
                                                        ...
                                                        submit-method = "post"
                                                        submit-data='{"redirect":"<?=UrlUtil::getCurrentUrl()?>","delete_event_id":<?=$value["id"]?>}' 
                                                        value="Delete" 
