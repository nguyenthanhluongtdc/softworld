	...
	public function loadDataForTheme() {
		if($this->session->isLogin()) {
			...
			if($this->checkRole(PageIdConstants::EVENT,$staff_role))
			{
				...
				$this->setAttribute("headerUrlEventCalendar", ActionUtil::getActionUrl(PageIdConstants::EVENT, "calendar"));
				$this->setAttribute("headerUrlEventTrash", ActionUtil::getActionUrl(PageIdConstants::EVENT, "trash"));
			}

			if($this->checkRole(PageIdConstants::TYPE_EVENT,$staff_role))
			{
				//社員検索
				$this->setAttribute("headerUrlTypeEvent", ActionUtil::getActionUrl(PageIdConstants::TYPE_EVENT));
				$this->setAttribute("headerUrlTypeEventRegist", ActionUtil::getActionUrl(PageIdConstants::TYPE_EVENT, "regist"));
			}
