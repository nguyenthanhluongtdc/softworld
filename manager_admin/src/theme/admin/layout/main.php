...
<html lang="ja">
    <head>
        <meta charset="utf-8">
        <title><?= isset($titlePage) ? $titlePage : "WEB ADMIN" ?></title>
        ...
        <link type="text/css" rel="stylesheet" href="../theme/admin/css/modal.css" />
        <link type="text/css" rel="stylesheet" href="../theme/admin/tb/css/fullcalendar.min.css" />
        <!--[if lt IE 9]>
        ...
        <?php
            if (isset($listErrorMessage)) {
                $errors = json_encode($listErrorMessage);?> appErrors = <?= $errors ?>;
        <?php } ?>
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="nav-no-collapse">
                            <ul class="nav pull-right usernav">
                                <li><a href="<?= $urlLogout ?>" onclick="return window.confirm('Bạn có muốn đăng xuất không!')"><span class="icon16 icomoon-icon-exit"></span>Log out</a></li>
                            </ul>
                        </div><!-- /.nav-collapse -->
                    </div>
                </div><!-- /navbar-inner -->
        ...
        <div class="modal">
            <div class="modal-body">
                <img src="../theme/admin/tb/images/sw-logo.png" alt="" width="80%">
                <div class="modal-content">Bạn có muốn xóa không!</div>
                <div class="modal-footer">
                    <label for="o" class="btn-danger">close</label>
                    <button class="btn-ok label">OK</button>
                </div>
            </div>
        </div>
