...
<html lang="ja">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="../theme/admin/css/bootstrap.css" />    
        <!--[if lt IE 9]>
        ...
        <script type="text/javascript" src="../theme/admin/js/main.js"></script>
        ...
        <style type="text/css">
            body{
                background: url(../theme/admin/tb/images/patterns/sidebar/grey.png) repeat;
            }
    ...
    <?php// echo($result_ex); ?>
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" href="<?= $UrlIndex ?>" style="font-size:28px;margin-left:-28px"><span class="slogan">ADMIN</span></a>
        ...
        <div id="wrapper">
            ...
            ?>
            <div id="copyright" style="text-align: center">Copyright © SEIYOU Corporation, All Rights Reserved.</div>
        </div>
        <!--end tab js-->
    </body>
</html>
